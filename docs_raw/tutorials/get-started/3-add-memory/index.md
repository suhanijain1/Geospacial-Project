...
# Add memory[¶](#add-memory "Permanent link")
...
## 1. Create a `MemorySaver` checkpointer[¶](#1-create-a-memorysaver-checkpointer "Permanent link")
...
```
## 3. Interact with your chatbot[¶](#3-interact-with-your-chatbot "Permanent link")
...
## 4. Ask a follow up question[¶](#4-ask-a-follow-up-question "Permanent link")
...
## 5. Inspect the state[¶](#5-inspect-the-state "Permanent link")
