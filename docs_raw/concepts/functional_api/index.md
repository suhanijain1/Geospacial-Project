...
# Functional API concepts[¶](#functional-api-concepts "Permanent link")
## Overview[¶](#overview "Permanent link")
The **Functional API** allows you to add LangGraph's key features — [persistence](../persistence/), [memory](../../how-tos/memory/add-memory/), [human-in-the-loop](../human_in_the_loop/), and [streaming](../streaming/) — to your applications with minimal changes to your existing code.
...
| **store** | An instance of [BaseStore](../../reference/store/#langgraph.store.base.BaseStore "<code class=\"doc-symbol doc-symbol-heading doc-symbol-class\"></code>            <span class=\"doc doc-object-name doc-class-name\">BaseStore</span>"). Useful for [long-term memory](../../how-tos/use-functional-api/#long-term-memory). |
| **writer** | Use to access the StreamWriter when working with Async Python < 3.11. See [streaming with functional API for details](../../how-tos/use-functional-api/#streaming). |
...
### Definition[¶](#definition_1 "Permanent link")
