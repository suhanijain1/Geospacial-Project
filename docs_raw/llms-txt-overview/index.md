...
# llms.txt[¶](#llmstxt "Permanent link")
...
code to production.
## Differences Between `llms.txt` and `llms-full.txt`[¶](#differences-between-llmstxt-and-llms-fulltxt "Permanent link")
...
## Using `llms.txt` via an MCP Server[¶](#using-llmstxt-via-an-mcp-server "Permanent link")
...
### 🚀 Use the `mcpdoc` Server[¶](#use-the-mcpdoc-server "Permanent link")
...
## Using `llms-full.txt`[¶](#using-llms-fulltxt "Permanent link")
