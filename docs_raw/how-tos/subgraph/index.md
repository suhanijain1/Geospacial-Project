...
# Use subgraphs[¶](#use-subgraphs "Permanent link")
...
## Shared state schemas[¶](#shared-state-schemas "Permanent link")
...
```
## Add persistence[¶](#add-persistence "Permanent link")
...
```
## View subgraph state[¶](#view-subgraph-state "Permanent link")
