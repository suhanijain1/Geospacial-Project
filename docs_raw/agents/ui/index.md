...
## Run agent in UI[¶](#run-agent-in-ui "Permanent link")
...
## Add human-in-the-loop[¶](#add-human-in-the-loop "Permanent link")
...
## Generative UI[¶](#generative-ui "Permanent link")
...
[Source](https://langchain-ai.github.io/langgraph/agents/ui/)
