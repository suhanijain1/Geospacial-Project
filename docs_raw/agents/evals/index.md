...
```
## Create evaluator[¶](#create-evaluator "Permanent link")
...
### LLM-as-a-judge[¶](#llm-as-a-judge "Permanent link")
...
```
## Run evaluator[¶](#run-evaluator "Permanent link")
...
[Source](https://langchain-ai.github.io/langgraph/agents/evals/)
