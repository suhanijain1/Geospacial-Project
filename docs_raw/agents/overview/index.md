...
# Agent development using prebuilt components[¶](#agent-development-using-prebuilt-components "Permanent link")
...
## What is an agent?[¶](#what-is-an-agent "Permanent link")
...
* [**Memory integration**](../../how-tos/memory/add-memory/): Native support for *short-term* (session-based) and *long-term* (persistent across sessions) memory, enabling stateful behaviors in chatbots and assistants.
...
## Visualize an agent graph[¶](#visualize-an-agent-graph "Permanent link")
